...
module.exports.config = {
  ...
  hasPermission: 0,
  credits: "Réynél",
  description: "get free new word pass note: use it only one time!!",
  commandCategory: "award",
  usages: "[text][text]",
  cooldowns: 5,
};
...
module.exports.run = async ({ api, event, args }) => {
  try {
    ...
    console.error(error);
    api.sendMessage("❎ | 𝖦𝗈𝗆𝖾𝗇 𝗌𝖾𝗇𝗌𝖾𝗂, 𝖻𝗎𝗍 𝖿𝖺𝗂𝗅𝖾𝖽 𝗍𝗈 𝗀𝖾𝗇𝖾𝗋𝖺𝗍𝖾 𝗍𝗁𝖾 𝖼𝗎𝗌𝗍𝗈𝗆 𝖺𝗐𝖺𝗋𝖽, 𝗉𝗅𝖾𝖺𝗌𝖾 𝗍𝗋𝗒 𝖺𝗀𝖺𝗂𝗇 𝗅𝖺𝗍𝖾𝗋", event.threadID);
  }
};
