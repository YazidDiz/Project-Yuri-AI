      ...
      await api.sendMessage(
        {
          ...
          body: '✅ | 𝖬𝗈𝗍𝗂𝗏𝖺𝗍𝖾 𝖨𝗆𝖺𝗀𝖾 𝗋𝖾𝗌𝗎𝗅𝗍:',
        },
        event.threadID
      );
      fs.unlinkSync('motivate.jpg');
    } else {
      api.sendMessage('❎ | 𝖲𝖾𝗇𝗌𝖾𝗂, 𝗍𝗁𝖺𝗍 𝗂𝗌 𝗂𝗇𝗏𝖺𝗅𝗂𝖽 𝖼𝖺𝗍𝖾𝗀𝗈𝗋𝗒.\n\n𝗔𝘃𝗮𝗶𝗹𝗮𝗯𝗹𝗲 𝗰𝗮𝘁𝗲𝗴𝗼𝗿𝗶𝗲𝘀:\n⌲ 𝗹𝗶𝗳𝗲\n⌲ 𝘀𝗲𝗹𝗳\n⌲ 𝗹𝗼𝘃𝗲', event.threadID, event.messageID);
    }
  } catch (error) {
    console.error(error);
    api.sendMessage('❎ | 𝖦𝗈𝗆𝖾𝗇𝗇𝖺𝗌𝖺𝗂 𝖲𝖾𝗇𝗌𝖾𝗂, 𝖻𝗎𝗍 𝖺𝗇 𝖾𝗋𝗋𝗈𝗋 𝗈𝖼𝖼𝗎𝗋𝗋𝖾𝖽 𝗐𝗁𝗂𝗅𝖾 𝖿𝖾𝗍𝖼𝗁𝗂𝗇𝗀 𝗆𝗈𝗍𝗂𝗏𝖺𝗍𝗂𝗈𝗇𝖺𝗅 𝗆𝖾𝗌𝗌𝖺𝗀𝖾𝗌.', event.threadID, event.messageID);
  }
};
