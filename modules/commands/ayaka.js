...
var min = Math.floor(Math.random() * 2);
  ...
  var money = data.money
      if(money < 0) api.sendMessage("ℹ️ | 𝖲𝖾𝗇𝗌𝖾𝗂, 𝗒𝗈𝗎 𝗇𝖾𝖾𝖽 $𝟣𝟢𝟢 𝗍𝗈 𝗌𝖾𝖾 𝗍𝗁𝖾 𝗉𝗁𝗈𝗍𝗈, 𝗂𝖿 𝗒𝗈𝗎 𝖽𝗈𝗇'𝗍 𝗁𝖺𝗏𝖾 𝖺𝗇𝗒 𝗆𝗈𝗇𝖾𝗒 𝗎𝗌𝖾 《𝖣𝖺𝗂𝗅𝗒》 𝗍𝗈 𝗀𝖾𝗍 $𝟣𝟢𝟢𝟢𝟢",event.threadID,event.messageID)
          else {
   Currencies.setData(event.senderID, options = {money: money - 0})
   var callback = () => api.sendMessage({body:`✅ | 𝖲𝖾𝗇𝗌𝖾𝗂, 𝗁𝖾𝗋𝖾'𝗌 𝗍𝗁𝖾 𝗉𝗁𝗈𝗍𝗈 𝗈𝖿 𝖺𝗒𝖺𝗄𝖺 💞 ${link.length}\n𝖬𝗂𝗇𝗎𝗌 -$𝟣𝟢𝟢 𝗎𝗌𝖽 𝗂𝗇 𝖾𝗑𝖼𝗁𝖺𝗇𝗀𝖾`,attachment: fs.createReadStream(__dirname + "/cache/1.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.jpg"), event.messageID); 
