...
const unloadModule = function ({ moduleList, threadID, messageID }) {
    ...
    return api.sendMessage(`✅ | 𝖬𝖺𝗌𝗍𝖾𝗋, 𝗌𝗎𝖼𝖼𝖾𝗌𝗌𝖿𝗎𝗅𝗅𝗒 𝗎𝗇𝗅𝗈𝖺𝖽𝖾𝖽 《${moduleList.length}》 𝗆𝗈𝖽𝗎𝗅𝖾(𝗌)`, threadID, messageID);
}
...
module.exports.run = function ({ event, args, api }) {
    ...
    switch (args[0]) {
        case "load": {
            if (moduleList.length == 0) return api.sendMessage("ℹ️ | 𝖬𝖺𝗌𝗍𝖾𝗋, 𝗍𝗁𝖾 𝗆𝗈𝖽𝗎𝗅𝖾 𝗇𝖺𝗆𝖾 𝖼𝖺𝗇𝗇𝗈𝗍 𝖻𝖾 𝖾𝗆𝗉𝗍𝗒", threadID, messageID);
        ...
        case "info": {
            ...
            if (!command) return api.sendMessage("❎ | 𝖬𝖺𝗌𝗍𝖾𝗋, 𝗍𝗁𝖾 𝗆𝗈𝖽𝗎𝗅𝖾 𝗒𝗈𝗎 𝖾𝗇𝗍𝖾𝗋𝖾𝖽 𝖽𝗈𝖾𝗌 𝗇𝗈𝗍 𝖾𝗑𝗂𝗌𝗍 𝗂𝗇 𝗆𝗒 𝗌𝗒𝗌𝗍𝖾𝗆", threadID, messageID);
            ...
            return api.sendMessage(
                ...
                "- 𝗖𝗼𝗱𝗲𝗱 𝗯𝘆: " + credits + "\n" +
                "- 𝗩𝗲𝗿𝘀𝗶𝗼𝗻: " + version + "\n" +
                "- 𝗥𝗲𝗾𝘂𝗲𝘀𝘁 𝗣𝗲𝗿𝗺𝗶𝘀𝘀𝗶𝗼𝗻𝘀: " + ((hasPermssion == 0) ? "𝖴𝗌𝖾𝗋" : (hasPermssion == 1) ? "𝖠𝖽𝗆𝗂𝗇𝗂𝗌𝗍𝗋𝖺𝗍𝗈𝗋𝗌" : "𝖡𝗈𝗍 𝗈𝗉𝖾𝗋𝖺𝗍𝗈𝗋" ) + "\n" +
                "- 𝗪𝗮𝗶𝘁𝗶𝗻𝗴 𝘁𝗶𝗺𝗲: " + cooldowns + "seconds(s)\n" +
                `- 𝗥𝗲𝗾𝘂𝗶𝗿𝗲𝗱 𝗽𝗮𝗰𝗸𝗮𝗴𝗲𝘀: ${(Object.keys(dependencies || {})).join(", ") || "𝖣𝗈 𝗇𝗈𝗍 𝗁𝖺𝗏𝖾"}`,
                threadID, messageID
            );
        }
        default: {
