...
module.exports.run = async ({ api, event, args }) => {
  ...
  if (!query) return api.sendMessage("ℹ️ | 𝖯𝗅𝖾𝖺𝗌𝖾 𝗉𝗋𝗈𝗏𝗂𝖽𝖾 𝖺 𝗍𝖾𝗑𝗍 𝗍𝗈 𝖼𝗋𝖾𝖺𝗍𝖾 𝗂𝗆𝖺𝗀𝗂𝗇𝖾 𝗂𝗆𝖺𝗀𝖾.", threadID, messageID);
  ...
  try {
    ...
    if (images.length > 0) {
      ...
      api.sendMessage({
        body: "✅ | 𝖲𝗎𝖼𝖼𝖾𝗌𝗌𝖿𝗎𝗅𝗅𝗒 𝗀𝖾𝗇𝖾𝗋𝖺𝗍𝖾𝖽 𝗌𝖾𝗇𝗌𝖾𝗂\n\n𝖣𝗈𝗇'𝗍 𝖿𝗈𝗋𝗀𝖾𝗍 𝗍𝗈 𝖿𝗈𝗅𝗅𝗈𝗐\nhttps://www.facebook.com/100080098527733",
