...
module.exports.run = async function ({ api, event, args }) {
  if (args.length < 1) {
    return api.sendMessage("ℹ️ | 𝖲𝖾𝗇𝗌𝖾𝗂, 𝗄𝗂𝗇𝖽𝗅𝗒 𝖿𝗎𝗋𝗇𝗂𝗌𝗁 𝖺 𝖽𝖾𝗌𝗂𝗀𝗇𝖺𝗍𝖾𝖽 𝖼𝗈𝗅𝗈𝗋 𝖽𝖾𝗇𝗈𝗆𝗂𝗇𝖺𝗍𝗂𝗈𝗇 𝗈𝗋 𝗂𝗍𝗌 𝖼𝗈𝗋𝗋𝖾𝗌𝗉𝗈𝗇𝖽𝗂𝗇𝗀 𝗁𝖾𝗑𝖺𝖽𝖾𝖼𝗂𝗆𝖺𝗅 𝖼𝗈𝖽𝖾. 𝗍𝗁𝗂𝗌 𝖼𝗈𝗆𝗆𝖺𝗇𝖽 𝗂𝗌 𝖾𝗆𝗉𝗅𝗈𝗒𝖾𝖽 𝖺𝗌 𝖿𝗈𝗅𝗅𝗈𝗐𝗌: >𝗁𝖾𝗑𝖼𝗈𝗅𝗈𝗋 [𝖼𝗈𝗅𝗈𝗋].", event.threadID, event.messageID);
  }
  ...
  if (colorMap[colorInput]) {
    ...
    outputStream.on("finish", () => {
      const response = `⌲ 𝗥𝗘𝗦𝗨𝗟𝗧\n\n𝖧𝖾𝗑𝖺𝖽𝖾𝖼𝗂𝗆𝖺𝗅 𝖼𝗈𝖽𝖾 𝖿𝗈𝗋 ${colorInput} 𝗂𝗌 ${hexCode}`;
      api.sendMessage(
    ...
    outputStream.on("finish", () => {
      const response = `ℹ️ | 𝖢𝗈𝗅𝗈𝗋 𝗉𝗋𝖾𝗏𝗂𝖾𝗐 𝖿𝗈𝗋 ${hexCode}`;
      api.sendMessage(
        { body: response, attachment: fs.createReadStream(colorPreviewPath) },
        event.threadID,
        event.messageID
    ...
    return api.sendMessage("❎ | 𝖲𝖾𝗇𝗌𝖾𝗂, 𝗍𝗁𝖺𝗍 𝗂𝗌 𝗂𝗇𝗏𝖺𝗅𝗂𝖽 𝖼𝗈𝗅𝗈𝗋 𝗇𝖺𝗆𝖾 𝗈𝗋 𝖼𝗈𝖽𝖾.", event.threadID, event.messageID);
  }
};