...
module.exports.handleEvent = async function ({ api, event }) {
  ...
  if (!args[0]) {
    api.sendMessage("🖋️ | 𝙺𝚘𝚗𝚗𝚒𝚌𝚑𝚒𝚠𝚊 𝚜𝚎𝚗𝚜𝚎𝚒, 𝙸 𝚊𝚖 𝙼𝚘𝚍𝚎𝚕 𝙲𝚑𝚊𝚝-𝙱𝚒𝚜𝚘𝚗 𝚁𝚎𝚙𝚕𝚒𝚝 𝙰𝙸 𝙸'𝚖 𝚙𝚊𝚛𝚝 𝚘𝚏 𝙶𝚘𝚘𝚐𝚕𝚎 𝚊 𝚕𝚊𝚗𝚐𝚞𝚊𝚐𝚎 𝚖𝚘𝚍𝚎𝚕 𝚝𝚛𝚊𝚒𝚗𝚎𝚍 𝚋𝚢 𝙶𝚘𝚘𝚐𝚕𝚎.\n━━━━━━━━━━━━━━━━━━━\n𝙷𝚘𝚠 𝚖𝚊𝚢 𝚒 𝚊𝚜𝚜𝚒𝚜𝚝 𝚢𝚘𝚞 𝚝𝚘𝚍𝚊𝚢?", threadID, messageID);
    return;
  }
  ...
  api.sendMessage("🗨️ | 𝚂𝚎𝚗𝚜𝚎𝚒, 𝚁𝚎𝚙𝚕𝚒𝚝 𝙰𝙸 𝚒𝚜 𝚝𝚑𝚒𝚗𝚔𝚒𝚗𝚐, 𝙿𝚕𝚎𝚊𝚜𝚎 𝚠𝚊𝚒𝚝...", threadID, messageID);
  ...
  try {
    ...
    console.log("🟢 | 𝚂𝚎𝚗𝚜𝚎𝚒, 𝚑𝚎𝚛𝚎'𝚜 𝚝𝚑𝚎 𝚁𝚎𝚜𝚙𝚘𝚗𝚜𝚎 𝚏𝚛𝚘𝚖 𝚁𝚎𝚙𝚕𝚒𝚝 𝙰𝙸:", response.data);
    ...
    if (response.data.bot_response.trim() !== "") {
      ...
      api.sendMessage("🚫 | 𝙶𝚘𝚖𝚎𝚗 𝚜𝚎𝚗𝚜𝚎𝚒, 𝚋𝚞𝚝 𝚗𝚘 𝚛𝚎𝚜𝚙𝚘𝚗𝚜𝚎 𝚏𝚘𝚞𝚗𝚍 𝚏𝚛𝚘𝚖 𝚁𝚎𝚙𝚕𝚒𝚝 𝙰𝙸.", threadID, messageID);
    }
  } catch (error) {
    console.error("🚫 | 𝙴𝚛𝚛𝚘𝚛:", error);

    if (error.response && error.response.status === 503) {
      api.sendMessage("🚫 | 𝙶𝚘𝚖𝚎𝚗 𝚜𝚎𝚗𝚜𝚎𝚒, 𝚋𝚞𝚝 𝚝𝚑𝚎 𝙰𝙿𝙸 𝚒𝚜 𝚞𝚗𝚊𝚟𝚊𝚒𝚕𝚊𝚋𝚕𝚎 𝚛𝚒𝚐𝚑𝚝 𝚗𝚘𝚠. 𝙿𝚕𝚎𝚊𝚜𝚎 𝚝𝚛𝚢 𝚊𝚐𝚊𝚒𝚗 𝚕𝚊𝚝𝚎𝚛.", threadID, messageID);
    } else {
      api.sendMessage("🚫 | 𝙶𝚘𝚖𝚎𝚗 𝚜𝚎𝚗𝚜𝚎𝚒, 𝚋𝚞𝚝 𝚝𝚑𝚎 𝙰𝙿𝙸 𝚒𝚜 𝚞𝚗𝚊𝚟𝚊𝚒𝚕𝚊𝚋𝚕𝚎 𝚛𝚒𝚐𝚑𝚝 𝚗𝚘𝚠. 𝙿𝚕𝚎𝚊𝚜𝚎 𝚝𝚛𝚢 𝚊𝚐𝚊𝚒𝚗 𝚕𝚊𝚝𝚎𝚛.", threadID, messageID);
    }
  }
