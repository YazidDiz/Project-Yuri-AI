...
module.exports.run = async ({ api, event, args }) => {
    if (!args[0]) {
        return api.sendMessage("ℹ️ | 𝖲𝖾𝗇𝗌𝖾𝗂, 𝗄𝗂𝗇𝖽𝗅𝗒 𝗉𝗋𝗈𝗏𝗂𝖽𝖾 𝖺𝗇 𝖨𝖯 𝖺𝖽𝖽𝗋𝖾𝗌𝗌 𝗍𝗈 𝗅𝗈𝗈𝗄𝗎𝗉.", event.threadID, event.messageID);
    }
...
🔍 | 𝖧𝖾𝗋𝖾'𝗌 𝗐𝗁𝖺𝗍 𝖨 𝖿𝗈𝗎𝗇𝖽 𝖿𝗈𝗋 𝖨𝖯 𝖺𝖽𝖽𝗋𝖾𝗌𝗌 ${ipAddress}:
...
🌞 | 𝗜𝘀 𝗗𝗦𝗧: ${data.time_zone.is_dst ? 'Yes' : 'No'}
🌞 | 𝗗𝗦𝗧 𝗦𝗔𝗩𝗜𝗡𝗚𝗦: ${data.time_zone.dst_savings}

🏠 | 𝗙𝗨𝗟𝗟 𝗔𝗗𝗗𝗥𝗘𝗦𝗦: ${data.city}, ${data.state_prov}, ${data.country_name}, ${data.zipcode}
🌐 | 𝗚𝗢𝗢𝗚𝗟𝗘 𝗠𝗔𝗣\n[𝖮𝗉𝖾𝗇 𝗂𝗇 𝖦𝗈𝗈𝗀𝗅𝖾 𝖬𝖺𝗉𝗌](https://www.google.com/maps?q=${data.latitude},${data.longitude})`;

   api.sendMessage(formattedResult, event.threadID, event.messageID);
        } else {
            api.sendMessage("❎ | 𝖦𝗈𝗆𝖾𝗇 𝗌𝖾𝗇𝗌𝖾𝗂, 𝖻𝗎𝗍 𝖺𝗇 𝖾𝗋𝗋𝗈𝗋 𝗁𝖺𝗌 𝗈𝖼𝖼𝗎𝗋𝗋𝖾𝖽 𝗐𝗁𝗂𝗅𝖾 𝖿𝖾𝗍𝖼𝗁𝗂𝗇𝗀 𝖨𝖯 𝗂𝗇𝖿𝗈𝗋𝗆𝖺𝗍𝗂𝗈𝗇.", event.threadID, event.messageID);
        }
    } catch (error) {
        console.error(error);
        api.sendMessage("❎ | 𝖦𝗈𝗆𝖾𝗇 𝗌𝖾𝗇𝗌𝖾𝗂, 𝖻𝗎𝗍 𝖺𝗇 𝖾𝗋𝗋𝗈𝗋 𝗁𝖺𝗌 𝗈𝖼𝖼𝗎𝗋𝗋𝖾𝖽 𝗐𝗁𝗂𝗅𝖾 𝖿𝖾𝗍𝖼𝗁𝗂𝗇𝗀 𝖨𝖯 𝗂𝗇𝖿𝗈𝗋𝗆𝖺𝗍𝗂𝗈𝗇.", event.threadID, event.messageID);
