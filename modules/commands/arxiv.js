...
module.exports.run = async function ({ api, event, args }) {
  ...
  if (!query) {
    api.sendMessage('ℹ️ | 𝖲𝖾𝗇𝗌𝖾𝗂, 𝗉𝗅𝖾𝖺𝗌𝖾 𝗉𝗋𝗈𝗏𝗂𝖽𝖾 𝖺 𝗌𝖾𝖺𝗋𝖼𝗁 𝗊𝗎𝖾𝗋𝗒 𝖿𝗈𝗋 𝖠𝗋𝗑𝗂𝗏.', threadID, messageID);
    return;
  }
  ...
  try {
    ...
    parser.parseString(xmlData, (error, result) => {
      if (error) {
        api.sendMessage('❎ | 𝖦𝗈𝗆𝖾𝗇𝗇𝖺𝗌𝖺𝗂 𝖲𝖾𝗇𝗌𝖾𝗂, 𝖻𝗎𝗍 𝖺𝗇 𝖾𝗋𝗋𝗈𝗋 𝗈𝖼𝖼𝗎𝗋𝗋𝖾𝖽 𝗐𝗁𝗂𝗅𝖾 𝗉𝖺𝗋𝗌𝗂𝗇𝗀 𝖠𝗋𝗑𝗂𝗏 𝖽𝖺𝗍𝖺.', threadID, messageID);
        console.error(error);
        return;
      }
      ...
      if (!entries || entries.length === 0) {
        api.sendMessage('❎ | 𝖦𝗈𝗆𝖾𝗇𝗇𝖺𝗌𝖺𝗂 𝖲𝖾𝗇𝗌𝖾𝗂, 𝖻𝗎𝗍 𝗇𝗈 𝗋𝖾𝗌𝖾𝖺𝗋𝖼𝗁 𝖺𝗋𝗍𝗂𝖼𝗅𝖾𝗌 𝖿𝗈𝗎𝗇𝖽 𝗈𝗇 𝖠𝗋𝗑𝗂𝗏 𝖿𝗈𝗋 𝗍𝗁𝖾 𝗀𝗂𝗏𝖾𝗇 𝗊𝗎𝖾𝗋𝗒.', threadID, messageID);
        return;
      }
    ...
    console.error(error);
    api.sendMessage('❎ | 𝖦𝗈𝗆𝖾𝗇𝗇𝖺𝗌𝖺𝗂 𝖲𝖾𝗇𝗌𝖾𝗂, 𝖻𝗎𝗍 𝖺𝗇 𝖾𝗋𝗋𝗈𝗋 𝗈𝖼𝖼𝗎𝗋𝗋𝖾𝖽 𝗐𝗁𝗂𝗅𝖾 𝖿𝖾𝗍𝖼𝗁𝗂𝗇𝗀 𝖠𝗋𝗑𝗂𝗏 𝖽𝖺𝗍𝖺.', threadID, messageID);
  }
};