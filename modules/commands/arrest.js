...
module.exports.run = async function ({ event, api, args }) {
    ...
    if (!mention) return api.sendMessage("ℹ️ | 𝖲𝖾𝗇𝗌𝖾𝗂, 𝗉𝗅𝖾𝖺𝗌𝖾 𝗆𝖾𝗇𝗍𝗂𝗈𝗇 𝟣 𝖯𝖾𝗋𝗌𝗈𝗇", threadID, messageID);
    else {
        var one = senderID, two = mention;
        return makeImage({ one, two }).then(path => api.sendMessage({ body: "𝖢𝗈𝗇𝗀𝗋𝖺𝗍𝗎𝗅𝖺𝗍𝗂𝗈𝗇𝗌 𝗈𝗇 𝖾𝗇𝗍𝖾𝗋𝗂𝗇𝗀 𝗍𝗁𝖾 𝗌𝗍𝖺𝗍𝖾 𝗉𝖺𝗒𝗋𝗈𝗅𝗅 " + tag + '\n 𝖶𝗂𝗌𝗁 𝗒𝗈𝗎 𝗁𝖺𝗉𝗉𝗒',
            mentions: [{
          tag: tag,
          id: mention
        }],
