module.exports.config = {
    ...
    hasPermssion: 0,
    credits: "Réynél",
    description: "anime blurred profile",
...
"https://i.postimg.cc/v8PP9Rd0/distorted.jpg",
    ...
    var callback = () => api.sendMessage({ body: `✅ | 𝖲𝖾𝗇𝗌𝖾𝗂, 𝗁𝖾𝗋𝖾'𝗌 𝗒𝗈𝗎𝗋 𝗋𝖺𝗇𝖽𝗈𝗆 𝖺𝗇𝗂𝗆𝖾 𝖻𝗅𝗎𝗋 𝖿𝗈𝗋 𝗉𝗋𝗈𝖿𝗂𝗅𝖾`, attachment: fs.createReadStream(__dirname + "/cache/5.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg"), event.messageID);
