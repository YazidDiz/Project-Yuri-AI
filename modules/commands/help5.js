...
module.exports.run = async function ({ api, event, args }) {
  ...
  let msg = `𝖧𝖾𝗒 𝖲𝖾𝗇𝗌𝖾𝗂 ${userName}, 𝗍𝗁𝖾𝗌𝖾 𝖺𝗋𝖾 𝖼𝗈𝗆𝗆𝖺𝗇𝖽𝗌 𝗍𝗁𝖺𝗍 𝗆𝖺𝗒 𝗁𝖾𝗅𝗉 𝗒𝗈𝗎:\n`;
  ...
  const randomQuotes = [
  "𝗢𝗰𝘁𝗼𝗽𝘂𝘀𝗲𝘀 𝗵𝗮𝘃𝗲 𝘁𝗵𝗿𝗲𝗲 𝗵𝗲𝗮𝗿𝘁𝘀: 𝗍𝗐𝗈 𝗉𝗎𝗆𝗉 𝖻𝗅𝗈𝗈𝖽 𝗍𝗈 𝗍𝗁𝖾 𝗀𝗂𝗅𝗅𝗌, 𝖺𝗇𝖽 𝗈𝗇𝖾 𝗉𝗎𝗆𝗉𝗌 𝗂𝗍 𝗍𝗈 𝗍𝗁𝖾 𝗋𝖾𝗌𝗍 𝗈𝖿 𝗍𝗁𝖾 𝖻𝗈𝖽𝗒.",
    "𝗛𝗼𝗻𝗲𝘆 𝗻𝗲𝘃𝗲𝗿 𝘀𝗽𝗼𝗶𝗹𝘀; 𝖺𝗋𝖼𝗁𝖺𝖾𝗈𝗅𝗈𝗀𝗂𝗌𝗍𝗌 𝗁𝖺𝗏𝖾 𝖿𝗈𝗎𝗇𝖽 𝗉𝗈𝗍𝗌 𝗈𝖿 𝗁𝗈𝗇𝖾𝗒 𝗂𝗇 𝖺𝗇𝖼𝗂𝖾𝗇𝗍 𝖤𝗀𝗒𝗉𝗍𝗂𝖺𝗇 𝗍𝗈𝗆𝖻𝗌 𝗍𝗁𝖺𝗍 𝖺𝗋𝖾 𝗈𝗏𝖾𝗋 𝟥,𝟢𝟢𝟢 𝗒𝖾𝖺𝗋𝗌 𝗈𝗅𝖽.",
