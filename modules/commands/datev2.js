...
module.exports.run = async function ({ event, api, args }) {
    ...
    if (!mention) return api.sendMessage("ℹ️ | 𝖲𝖾𝗇𝗌𝖾𝗂, 𝗉𝗅𝖾𝖺𝗌𝖾 𝗍𝖺𝗀 𝟣 𝗉𝖾𝗋𝗌𝗈𝗇", threadID, messageID);
    else {
        var one = senderID, two = mention;
        return makeImage({ one, two }).then(path => api.sendMessage({ body: "𝖲𝗁𝗂𝗉 𝖺𝗇𝖽 𝗀𝖾𝗍 𝗆𝖺𝗋𝗋𝗂𝖾𝖽 >\\<",
            mentions: [{
          tag: tag,
          id: mention
        }],
