...
module.exports.config = {
    ...
    version: "1.0.0",
    credits: "Réynél",
    description: "Artificial Intelligence Driven Dynamic Network",
    commandCategory: "ai",
    usages: "[prompt]",
    cooldowns: 5,
};
...
module.exports.run = async ({ api, event, args }) => {
    ...
    try {
        ...
        api.sendMessage('❎ | 𝙶𝚘𝚖𝚎𝚗 𝚜𝚎𝚗𝚜𝚎𝚒, 𝚊𝚗 𝚎𝚛𝚛𝚘𝚛 𝚘𝚌𝚌𝚞𝚛𝚛𝚎𝚍 𝚠𝚑𝚒𝚕𝚎 𝚙𝚛𝚘𝚌𝚎𝚜𝚜𝚒𝚗𝚐 𝚝𝚑𝚎 𝚛𝚎𝚜𝚙𝚘𝚗𝚜𝚎. 𝙿𝚕𝚎𝚊𝚜𝚎 𝚝𝚛𝚢 𝚊𝚐𝚊𝚒𝚗 𝚕𝚊𝚝𝚎𝚛.', event.threadID, event.messageID);
    }
};