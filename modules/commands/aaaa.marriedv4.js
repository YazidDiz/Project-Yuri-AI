...
module.exports.run = async function ({ event, api, args }) {    
    ...
    if (!mention[0]) return api.sendMessage("ℹ️ | 𝖲𝖾𝗇𝗌𝖾𝗂, 𝗄𝗂𝗇𝖽𝗅𝗒 𝗆𝖾𝗇𝗍𝗂𝗈𝗇 𝟣 𝗉𝖾𝗋𝗌𝗈𝗇 𝗒𝗈𝗎 𝗆𝖺𝗋𝗋𝗂𝖾𝖽", threadID, messageID);
        ...
        return makeImage({ one, two }).then(path => api.sendMessage({ body: "𝘏𝘦𝘳𝘦'𝘴 𝘵𝘰 𝘵𝘩𝘦 𝘣𝘦𝘨𝘪𝘯𝘯𝘪𝘯𝘨 𝘰𝘧 𝘰𝘶𝘳 𝘣𝘦𝘢𝘶𝘵𝘪𝘧𝘶𝘭 𝘫𝘰𝘶𝘳𝘯𝘦𝘺 𝘵𝘰𝘨𝘦𝘵𝘩𝘦𝘳", attachment: fs.createReadStream(path) }, threadID, () => fs.unlinkSync(path), messageID));
    }
      }
