...
module.exports.run = async ({ event, api, args, Users }) => {
  ...
  api.sendMessage({body: "𝘒𝘪𝘴𝘴𝘪𝘯𝘨 𝘺𝘰𝘶 𝘪𝘴 𝘭𝘪𝘬𝘦 𝘢 𝘴𝘸𝘦𝘦𝘵 𝘥𝘳𝘦𝘢𝘮 𝘤𝘰𝘮𝘦 𝘵𝘳𝘶𝘦", attachment: fs.createReadStream(path_trash)}, event.threadID, () => fs.unlinkSync(path_trash), event.messageID);
}
