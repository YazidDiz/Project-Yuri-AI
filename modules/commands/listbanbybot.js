    ...
    case "-t":
      {
        ...
        return api.sendMessage(listBanned.length != 0 ? api.sendMessage(`ℹ️ | 𝖬𝖺𝗌𝗍𝖾𝗋, 𝗍𝗁𝖾 𝖼𝗎𝗋𝗋𝖾𝗇𝗍𝗅𝗒 ${listBanned.length} 𝗀𝗋𝗈𝗎𝗉𝗌 𝗁𝖺𝗏𝗂𝗇𝗀 𝖻𝗈𝗍 𝖻𝖺𝗇𝗇𝖾𝖽\n\n${listBanned.join("\n")}` +
          "\n\nℹ️ | 𝖬𝖺𝗌𝗍𝖾𝗋, 𝗄𝗂𝗇𝖽𝗅𝗒 𝗋𝖾𝗉𝗅𝗒 𝗍𝗈 𝗆𝖾𝗌𝗌𝖺𝗀𝖾 + 𝗈𝗋𝖽𝖾𝗋 𝗇𝗎𝗆𝖻𝖾𝗋 -> 𝗎𝗇𝖻𝖺𝗇",
          threadID, (error, info) => {
          ...
          messageID
        ) : "ℹ️ | 𝖬𝖺𝗌𝗍𝖾𝗋, 𝗍𝗁𝖾𝗋𝖾 𝖺𝗋𝖾 𝖼𝗎𝗋𝗋𝖾𝗇𝗍𝗅𝗒 𝗇𝗈 𝖻𝖺𝗇𝗇𝖾𝖽 𝗀𝗋𝗈𝗎𝗉𝗌.", threadID, messageID);
      }
    case "user":
    case "u":
    case "-u":
      {
        ...
        return api.sendMessage(listBanned.length != 0 ? api.sendMessage(`ℹ️ | 𝖬𝖺𝗌𝗍𝖾𝗋, 𝗍𝗁𝖾 𝖼𝗎𝗋𝗋𝖾𝗇𝗍𝗅𝗒 ${listBanned.length} 𝗎𝗌𝖾𝗋𝗌 𝗁𝖺𝗏𝗂𝗇𝗀 𝖻𝗈𝗍 𝖻𝖺𝗇𝗇𝖾𝖽\n\n${listBanned.join("\n")}` +
          "\n\nℹ️ | 𝖬𝖺𝗌𝗍𝖾𝗋, 𝗄𝗂𝗇𝖽𝗅𝗒 𝗋𝖾𝗉𝗅𝗒 𝗍𝗈 𝗆𝖾𝗌𝗌𝖺𝗀𝖾 + 𝗈𝗋𝖽𝖾𝗋 𝗇𝗎𝗆𝖻𝖾𝗋 -> 𝗎𝗇𝖻𝖺𝗇",
          threadID, (error, info) => {
          ...
          messageID
        ) : "❎ | 𝖬𝖺𝗌𝗍𝖾𝗋, 𝗍𝗁𝖾𝗋𝖾 𝖺𝗋𝖾 𝖼𝗎𝗋𝗋𝖾𝗇𝗍𝗅𝗒 𝗇𝗈 𝖻𝖺𝗇𝗇𝖾𝖽 𝗎𝗌𝖾𝗋𝗌", threadID, messageID);
      }
