...
module.exports.run = async function ({ event, api, args }) {
    ...
    if (!mention) return api.sendMessage("ℹ️ | 𝖲𝖾𝗇𝗌𝖾𝗂, 𝗄𝗂𝗇𝖽𝗅𝗒 𝗍𝖺𝗀 𝗈𝗇𝖾 𝗉𝖾𝗋𝗌𝗈𝗇.", threadID, messageID);
    else {
        var one = senderID, two = mention;
        return makeImage({ one, two }).then(path => api.sendMessage({ body: "𝖧𝗈𝗅𝖽 𝗁𝖺𝗇𝖽𝗌 𝗍𝗂𝗀𝗁𝗍𝗅𝗒 " + tag + ' 𝖽𝗈𝗇’𝗍 𝗅𝖾𝗍 𝗀𝗈 𝗆𝗒 𝗅𝗈𝗏𝖾 ❤',
            mentions: [{
          tag: tag,
          id: mention
        }],
