...
module.exports.run = async function ({ api, event, args, Users }) {
  if ((this.config.credits) != "Réynél") { return api.sendMessage(`Detected credits have been changed`, event.threadID, event.messageID)}
  ...
  let pathAvata = __dirname + `/cache/cardcute2.png`;
  /*                 */
...
ctx.fillStyle = "#EEC591";
  ...
  return api.sendMessage(
    { body: "✅ | 𝖲𝖾𝗇𝗌𝖾𝗂, 𝗁𝖾𝗋𝖾'𝗌 𝗒𝗈𝗎𝗋 𝖼𝖺𝗋𝖽𝖼𝗎𝗍𝖾 𝟤 𝖻𝖺𝗇𝗇𝖾𝗋", attachment: fs.createReadStream(pathImg) },
    threadID,
