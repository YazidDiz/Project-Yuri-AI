...
module.exports.run = async function({ api, event, args }) {
    ...
    if (args.length === 0) {
        ...
        if (!text) {
            return api.sendMessage("ℹ️ | 𝖲𝖾𝗇𝗌𝖾𝗂, 𝗉𝗅𝖾𝖺𝗌𝖾 𝖾𝗇𝗍𝖾𝗋 𝗍𝗁𝖾 𝗍𝖾𝗑𝗍 𝗒𝗈𝗎 𝗐𝖺𝗇𝗍 𝗍𝗈 𝖾𝗇𝖼𝗈𝖽𝖾 𝗂𝗇𝗍𝗈 𝖺 𝖰𝖱 𝖼𝗈𝖽𝖾.", event.threadID, event.messageID);
        }
        ...
        api.sendMessage(`ℹ️ | 𝖲𝖾𝗇𝗌𝖾𝗂, 𝗁𝖾𝗋𝖾’𝗌 𝗍𝗁𝖾 𝖺𝗏𝖺𝗂𝗅𝖺𝖻𝗅𝖾 𝖼𝗈𝗅𝗈𝗋𝗌:\n${colorList}`, event.threadID, event.messageID);
    } else if (args.length === 1) {
        api.sendMessage("ℹ️ | 𝖲𝖾𝗇𝗌𝖾𝗂, 𝗉𝗅𝖾𝖺𝗌𝖾 𝗎𝗌𝖾 𝗍𝗁𝖾 '-' 𝗌𝖾𝗉𝖺𝗋𝖺𝗍𝗈𝗋 𝗍𝗈 𝗌𝗉𝖾𝖼𝗂𝖿𝗒 𝗍𝗁𝖾 𝖼𝗈𝗅𝗈𝗋.\n\n𝗘𝘅𝗮𝗺𝗽𝗹𝗲: 𝗊𝗋𝖼𝗈𝖽𝖾 𝗋𝖾𝖽 - [𝗍𝖾𝗑𝗍]", event.threadID, event.messageID);
        ...
        api.sendMessage("❎ | 𝖲𝖾𝗇𝗌𝖾𝗂, 𝗍𝗁𝖺𝗍 𝗂𝗌 𝗂𝗇𝗏𝖺𝗅𝗂𝖽 𝗂𝗇𝗉𝗎𝗍. 𝖯𝗅𝖾𝖺𝗌𝖾 𝗎𝗌𝖾 𝗍𝗁𝖾 '-' 𝗌𝖾𝗉𝖺𝗋𝖺𝗍𝗈𝗋 𝗍𝗈 𝗌𝗉𝖾𝖼𝗂𝖿𝗒 𝗍𝗁𝖾 𝖼𝗈𝗅𝗈𝗋.\n\n𝗘𝘅𝗮𝗺𝗽𝗹𝗲: 𝗊𝗋𝖼𝗈𝖽𝖾 𝗋𝖾𝖽 - [𝗍𝖾𝗑𝗍]", event.threadID, event.messageID);
    }
    }
