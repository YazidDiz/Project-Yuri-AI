...
module.exports.run = async function ({ api, event, args, client, Users, Threads, __GLOBAL, Currencies }) {
  ...
  const callback = () => api.sendMessage({ body: `𝖣𝖾𝗅𝗎𝗅𝗎 𝖳𝗐𝖳`, attachment: fs.createReadStream(__dirname + "/cache/kira.jpeg") }, threadID, () => fs.unlinkSync(__dirname + "/cache/kira.jpeg"));
