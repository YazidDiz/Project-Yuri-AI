module.exports.config = {
	...
	hasPermssion: 0,
	credits: "Réynél",
	description: "spank a person that you mention",
...
module.exports.run = async ({ event, api, args, Users }) => {
  ...
  api.sendMessage({body: "𝖸𝗈𝗎 𝗇𝖺𝗎𝗀𝗁𝗍𝗒 𝗄𝗂𝖽!!!", attachment: fs.createReadStream(path_trash)}, event.threadID, () => fs.unlinkSync(path_trash), event.messageID);
}
