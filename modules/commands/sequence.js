...
module.exports.run = async function({ api, event, args }) {
  ...
  if (isNaN(a1) || isNaN(n) || isNaN(dr)) {
    api.sendMessage(`ℹ️ | ${userName} 𝗌𝖾𝗇𝗌𝖾𝗂, 𝗉𝗅𝖾𝖺𝗌𝖾 𝗉𝗋𝗈𝗏𝗂𝖽𝖾 𝗏𝖺𝗅𝗂𝖽 𝗇𝗎𝗆𝖾𝗋𝗂𝖼 𝗂𝗇𝗉𝗎𝗍𝗌.`, threadID, messageID);
    return;
  }
  ...
  if (sequenceType === "arithmetic") {
    ...
    const availableCategories = "𝗔𝗩𝗔𝗜𝗟𝗔𝗕𝗟𝗘 𝗖𝗔𝗧𝗘𝗚𝗢𝗥𝗜𝗘𝗦\n\n   ⓵ 𝖠𝗋𝗂𝗍𝗁𝗆𝖾𝗍𝗂𝖼\n   ⓶ 𝖦𝖾𝗈𝗆𝖾𝗍𝗋𝗂𝖼\n   ➂ 𝖥𝗂𝖻𝗈𝗇𝖺𝖼𝖼𝗂";
    api.sendMessage(`❎ | 𝖲𝖾𝗇𝗌𝖾𝗂, 𝗍𝗁𝖺𝗍 𝗂𝗌 𝗎𝗇𝗌𝗎𝗉𝗉𝗈𝗋𝗍𝖾𝖽 𝖼𝖺𝗍𝖾𝗀𝗈𝗋𝗒. ${availableCategories}`, threadID, messageID);
    return;
  }
