...
module.exports.config = {
	...
	hasPermssion: 1,
	credits: "Réynél",
	description: "view uptime information",
...
let a = await loadImage(pathAva)
    ...
    ctx.fillStyle = "#000"
    ctx.fillText("PROJECT YURI", canvas.width / 2 - 660, 1000);
