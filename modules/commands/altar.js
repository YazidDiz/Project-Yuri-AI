...
try {
  ...
  const canvas = Canvas.createCanvas(960, 634);
	...
	fs.writeFileSync(path_toilet,imageBuffer);
	 api.sendMessage({attachment: fs.createReadStream(path_toilet, {'highWaterMark': 128 * 1024}), body: "𝗵𝗲𝘆, 𝗵𝗼𝘄 𝗮𝗿𝗲 𝘆𝗼𝘂? :))"}, event.threadID, () => fs.unlinkSync(path_toilet), event.messageID);
}
catch(e) {api.sendMessage(e.stack, event.threadID )}
}
// Text by Réynél - do not clear this line & forget me !
