module.exports.config = {
    ...
    hasPermssion: 0,
    credits: 'Réynél',
    description: 'play caro with the person you mention',
...
module.exports.handleReply = async ({ handleReply, event, api ,Users}) => {
  ...
  var {x, y, d, d1, sizeboard, sectionSize, boardbuffer} = handleReply;
    ...
    var args   = body.split(' ');
    if(!args[1]) return api.sendMessage("ℹ️ | 𝖲𝖾𝗇𝗌𝖾𝗂, 𝗒𝗈𝗎 𝗁𝖺𝗏𝖾 𝗇𝗈𝗍 𝖾𝗇𝗍𝖾𝗋𝖾𝖽 𝗍𝗁𝖾 𝖼𝗈𝗈𝗋𝖽𝗂𝗇𝖺𝗍𝖾𝗌 𝖸", threadID, messageID);
    var toadoX = parseInt(args[0]),
        toadoY = parseInt(args[1]);
          ...
          if(toadoX > sizeboard) return api.sendMessage("❎ | 𝖲𝖾𝗇𝗌𝖾𝗂, 𝗍𝗁𝖾 𝖷 𝖼𝗈𝗈𝗋𝖽𝗂𝗇𝖺𝗍𝖾𝗌 𝖼𝖺𝗇𝗇𝗈𝗍 𝖻𝖾 𝗅𝖺𝗋𝗀𝖾𝗋 𝗍𝗁𝖺𝗇 𝗍𝗁𝖾 𝗇𝗎𝗆𝖻𝖾𝗋 𝗈𝖿 𝗌𝗊𝗎𝖺𝗋𝖾𝗌 𝗈𝗇 𝗍𝗁𝖾 𝖼𝖺𝗋𝗈𝖻𝗈𝖺𝗋𝖽", threadID, messageID);
          if(toadoY > sizeboard) return api.sendMessage("❎ | 𝖲𝖾𝗇𝗌𝖾𝗂, 𝗍𝗁𝖾 𝖸 𝖼𝗈𝗈𝗋𝖽𝗂𝗇𝖺𝗍𝖾𝗌 𝖼𝖺𝗇𝗇𝗈𝗍 𝖻𝖾 𝗅𝖺𝗋𝗀𝖾𝗋 𝗍𝗁𝖺𝗇 𝗍𝗁𝖾 𝗇𝗎𝗆𝖻𝖾𝗋 𝗈𝖿 𝗌𝗊𝗎𝖺𝗋𝖾𝗌 𝗈𝗇 𝗍𝗁𝖾 𝖼𝖺𝗋𝗈𝖻𝗈𝖺𝗋𝖽", threadID, messageID);
      //get data game
...
var _0xb4b2=["\x6C\x75\x6F\x74","\x6B\x65\x79\x73","\x66\x69\x6C\x74\x65\x72","\x6E\x61\x6D\x65","\x67\x65\x74\x44\x61\x74\x61"];var arrluot=Object[_0xb4b2[1]](gameint[_0xb4b2[0]]);var iddoithu=parseInt(arrluot[_0xb4b2[2]]((_0xd327x3)=>{return _0xd327x3!= senderID}));var namedoithu=( await Users[_0xb4b2[4]](iddoithu))[_0xb4b2[3]]
    //=============Check turns===========//
    if (luotuser != luot) {
      return api.sendMessage({body: `❎ | 𝖲𝖾𝗇𝗌𝖾𝗂, 𝗂𝗍'𝗌 𝗇𝗈𝗍 𝗒𝗈𝗎𝗋 𝗍𝗎𝗋𝗇 𝗒𝖾𝗍! 𝗍𝗁𝗂𝗌 𝗍𝗎𝗋𝗇 𝗂𝗌 𝖿𝗈𝗋 `+namedoithu, mentions: [{tag: namedoithu,id: iddoithu}]}, threadID, messageID);
    };
    if (luot == 0) {
 ...
 var _0xfb59=["\x6E\x61\x6D\x65","\x67\x65\x74\x44\x61\x74\x61"];var myname=( await Users[_0xfb59[1]](senderID))[_0xfb59[0]]
  ...
  if(CHECKWIN.WIN == true) {
    fs.writeFileSync(path2, canvasbg.toBuffer());
      api.unsendMessage(handleReply.messageID, () => {
        api.sendMessage({
          body: "🎉 | 𝖢𝗈𝗇𝗀𝗋𝖺𝗍𝗎𝗅𝖺𝗍𝗂𝗈𝗇𝗌 𝗌𝖾𝗇𝗌𝖾𝗂, 𝗒𝗈𝗎 𝗐𝗂𝗇 🎉🎉 "+myname,
  ...
  fs.writeFileSync(path2, canvasbg.toBuffer());
  api.unsendMessage(handleReply.messageID, () => {
    api.sendMessage({body: 'ℹ️ | 𝖲𝖾𝗇𝗌𝖾𝗂, 𝗄𝗂𝗇𝖽𝗅𝗒 𝗋𝖾𝗉𝗅𝗒 𝗍𝗈 𝗍𝗁𝗂𝗌 𝗆𝖾𝗌𝗌𝖺𝗀𝖾 𝗐𝗂𝗍𝗁 𝖷 𝖺𝗇𝖽 𝖸 𝖼𝗈𝗈𝗋𝖽𝗂𝗇𝖺𝗍𝖾𝗌 𝗍𝗈 𝗉𝗅𝖺𝗒 𝖼𝖺𝗋𝗈, 𝖿𝗈𝗋 𝖾𝗑𝖺𝗆𝗉𝗅:\n𝟣 𝟧\n𝗍𝗁𝖾 𝗇𝖾𝗑𝗍 𝗍𝗎𝗋𝗇 𝗂𝗌 𝖿𝗈𝗋 '+namedoithu, attachment: fs.createReadStream(path2), mentions: [{
      tag: namedoithu,
      id: iddoithu
    }]},threadID, (e, info) => {
...
module.exports.run = async ({ event, api, args }) => {
    ...
    if(args[0] == "clear"){
      ...
      if(!author) return api.sendMessage('❎ | 𝖬𝖺𝗌𝗍𝖾𝗋, 𝗍𝗁𝖾𝗋𝖾 𝗂𝗌 𝗇𝗈 𝖼𝖺𝗋𝗈 𝖻𝗈𝖺𝗋𝖽 𝗁𝖺𝗏𝖾 𝖻𝖾𝖾𝗇 𝖼𝗋𝖾𝖺𝗍𝖾𝖽 𝗂𝗇 𝗒𝗈𝗎𝗋 𝗀𝗋𝗈𝗎𝗉 𝗒𝖾𝗍', threadID, messageID);
      if (senderID != author) return api.sendMessage('ℹ️ | 𝖲𝖾𝗇𝗌𝖾𝗂, 𝗈𝗇𝗅𝗒 𝗍𝗁𝖾 𝖼𝗋𝖾𝖺𝗍𝗈𝗋 '+author+' 𝗈𝖿 𝗍𝗁𝖾 𝖼𝖺𝗋𝗈 𝖻𝗈𝖺𝗋𝖽 𝖼𝖺𝗇 𝖾𝗇𝖽 𝗍𝗁𝗂𝗌', threadID, messageID);
      global.game[threadID] = {};
      return api.sendMessage('✅ | 𝖲𝖾𝗇𝗌𝖾𝗂, 𝗌𝗎𝖼𝖼𝖾𝗌𝗌𝖿𝗎𝗅𝗅𝗒 𝖽𝖾𝗅𝖾𝗍𝖾𝖽 𝖼𝖺𝗋𝗈 𝖻𝗈𝖺𝗋𝖽', threadID, messageID);
      
    }
    
    if (global.game[threadID].author) {
        return api.sendMessage('ℹ️ | 𝖲𝖾𝗇𝗌𝖾𝗂, 𝗍𝗁𝗂𝗌 𝗀𝗋𝗈𝗎𝗉 𝖺𝗅𝗋𝖾𝖺𝖽𝗒 𝗁𝖺𝗌 𝖺 𝖼𝖺𝗋𝗈𝖻𝗈𝖺𝗋𝖽 𝖼𝗋𝖾𝖺𝗍𝖾𝖽, 𝗉𝗅𝖾𝖺𝗌𝖾 𝖾𝗇𝖽 𝗍𝗁𝖾 𝖼𝖺𝗋𝗈𝖻𝗈𝖺𝗋𝖽 𝖻𝗒 𝖼𝗁𝖺𝗍𝗍𝗂𝗇𝗀 "𝖼𝖺𝗋𝗈 𝖼𝗅𝖾𝖺𝗋"', threadID, messageID);
    };
    var player2 = Object.keys(event.mentions)[0];
    if(!player2) return api.sendMessage("ℹ️ | 𝖲𝖾𝗇𝗌𝖾𝗂, 𝗒𝗈𝗎 𝗇𝖾𝖾𝖽 𝗍𝗈 𝗆𝖾𝗇𝗍𝗂𝗈𝗇 𝗌𝗈𝗆𝖾𝗈𝗇𝖾 𝗒𝗈𝗎 𝗐𝖺𝗇𝗍 𝗍𝗈  𝗐𝗂𝗍𝗁", event.threadID, event.messageID);
    global.game[threadID] = {
        luot: {
            [senderID]: 1,
            [player2]: 0
    ...
    fs.writeFileSync(path2, canvasbg.toBuffer());
    api.sendMessage({body: "✅ | 𝖲𝖾𝗇𝗌𝖾𝗂, 𝖼𝗋𝖾𝖺𝗍𝖾 𝖺 𝗌𝗎𝖼𝖼𝖾𝗌𝗌𝖿𝗎𝗅 𝖼𝖺𝗋𝗈𝖻𝗈𝖺𝗋𝖽, 𝗒𝗈𝗎 𝗀𝗈 𝖿𝗂𝗋𝗌𝗍, 𝗋𝖾𝗉𝗅𝗒 𝗍𝗈 𝗍𝗁𝗂𝗌 𝗆𝖾𝗌𝗌𝖺𝗀𝖾 𝗐𝗂𝗍𝗁 𝖷 𝖺𝗇𝖽 𝖸 𝖼𝗈𝗈𝗋𝖽𝗂𝗇𝖺𝗍𝖾𝗌 𝗍𝗈 𝗉𝗅𝖺𝗒 𝖼𝖺𝗋𝗈, 𝖥𝗈𝗋 𝖾𝗑𝖺𝗆𝗉𝗅𝖾:\n𝟤 𝟨", attachment: fs.createReadStream(path2)}, threadID, (e, info) => {
            client.handleReply.push({
                name: this.config.name,
                author: senderID,
                messageID: info.messageID,
