module.exports.config = {
	...
	hasPermssion: 0,
	credits: "Réynél",
	description: "pair to someone random in your group",
...
var one = senderID, two = id;
    return makeImage({ one, two }).then(path => api.sendMessage({ body: `𝖢𝗈𝗇𝗀𝗋𝖺𝗍𝗎𝗅𝖺𝗍𝗂𝗈𝗇𝗌, 𝗌𝖾𝗇𝗌𝖾𝗂 ${namee} 𝗂𝗌 𝗉𝖺𝗂𝗋𝖾𝖽 𝗐𝗂𝗍𝗁 𝗌𝖾𝗇𝗌𝖾𝗂 ${name} \n𝖳𝗁𝖾 𝗈𝖽𝖽𝗌 𝖺𝗋𝖾 《${tle}》`, mentions: arraytag, attachment: fs.createReadStream(path) }, threadID, () => fs.unlinkSync(path), messageID));
}
