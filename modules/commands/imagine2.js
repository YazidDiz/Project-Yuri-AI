...
module.exports.run = async function ({ api, event, args }) {
  ...
  if (!text) {
    return api.sendMessage("ℹ️ | 𝖲𝖾𝗇𝗌𝖾𝗂, 𝗉𝗅𝖾𝖺𝗌𝖾 𝗉𝗋𝗈𝗏𝗂𝖽𝖾 𝖺 𝗉𝗋𝗈𝗆𝗉𝗍.", threadID, messageID);
  }
  ...
  if (text.includes("|")) {
    ...
    if (!isNaN(modelInput) && !isNaN(ratioInput)) {
      ...
      if (modelNumber >= 1 && modelNumber <= models.length) {
        ...
        return api.sendMessage("❎ | 𝖲𝖾𝗇𝗌𝖾𝗂, 𝗍𝗁𝖺𝗍 𝗂𝗌 𝗂𝗇𝗏𝖺𝗅𝗂𝖽 𝗆𝗈𝖽𝖾𝗅 𝗇𝗎𝗆𝖻𝖾𝗋. 𝖯𝗅𝖾𝖺𝗌𝖾 𝗎𝗌𝖾 𝖺 𝗏𝖺𝗅𝗂𝖽 𝗇𝗎𝗆𝖻𝖾𝗋 𝖿𝗋𝗈𝗆 𝗍𝗁𝖾 𝗀𝗎𝗂𝖽𝖾.", threadID, messageID);
      }

      if (ratioNumber >= 0 && ratioNumber < ratios.length) {
        r = ratios[ratioNumber];
      } else {
        return api.sendMessage("❎ | 𝖲𝖾𝗇𝗌𝖾𝗂, 𝗍𝗁𝖺𝗍 𝗂𝗌 𝗂𝗇𝗏𝖺𝗅𝗂𝖽 𝗋𝖺𝗍𝗂𝗈 𝗇𝗎𝗆𝖻𝖾𝗋. 𝖯𝗅𝖾𝖺𝗌𝖾 𝗎𝗌𝖾 𝖺 𝗏𝖺𝗅𝗂𝖽 𝗋𝖺𝗍𝗂𝗈 𝗇𝗎𝗆𝖻𝖾𝗋 𝖿𝗋𝗈𝗆 𝗍𝗁𝖾 𝖺𝗏𝖺𝗂𝗅𝖺𝖻𝗅𝖾 𝗈𝗉𝗍𝗂𝗈𝗇𝗌.", threadID, messageID);
      }
    } else {
      return api.sendMessage("❎ | 𝖲𝖾𝗇𝗌𝖾𝗂, 𝗍𝗁𝖺𝗍 𝗂𝗌 𝗂𝗇𝗏𝖺𝗅𝗂𝖽 𝗂𝗇𝗉𝗎𝗍 𝖿𝗈𝗋 𝗆𝗈𝖽𝖾𝗅 𝗈𝗋 𝗋𝖺𝗍𝗂𝗈. 𝖯𝗅𝖾𝖺𝗌𝖾 𝗎𝗌𝖾 𝗏𝖺𝗅𝗂𝖽 𝗇𝗎𝗆𝖻𝖾𝗋𝗌 𝖿𝗈𝗋 𝗆𝗈𝖽𝖾𝗅 𝖺𝗇𝖽 𝗋𝖺𝗍𝗂𝗈.", threadID, messageID);
    }
  } else {
    prompt = text;
    ss = "46846";
  ...
  const waitingMessage = await api.sendMessage("⏳ | 𝖲𝖾𝗇𝗌𝖾𝗂, 𝖨'𝗆 𝗉𝗋𝗈𝖼𝖾𝗌𝗌𝗂𝗇𝗀 𝗒𝗈𝗎𝗋 𝗂𝗆𝖺𝗀𝖾, 𝗉𝗅𝖾𝖺𝗌𝖾 𝗐𝖺𝗂𝗍...", threadID, MessageID);
  try {
  ...
  api.sendMessage( {
    ...
    console.error(error);
    api.sendMesaage("❎ | 𝖦𝗈𝗆𝖾𝗇 𝗌𝖾𝗇𝗌𝖾𝗂, 𝖻𝗎𝗍 𝖺𝗇 𝖾𝗋𝗋𝗈𝗋 𝗁𝖺𝗌 𝗈𝖼𝖼𝗎𝗋𝗋𝖾𝖽.", threadID, messageID);
   }
};