...
module.exports.handleEvent = async function ({ api, event }) {
  ...
  api.sendMessage("🕟 | 𝚂𝚎𝚗𝚜𝚎𝚒, 𝙶𝚃𝙰-𝚅 𝙶𝚎𝚗𝚎𝚛𝚊𝚝𝚒𝚗𝚐 𝙿𝚛𝚘𝚖𝚙𝚝, 𝙿𝚕𝚎𝚊𝚜𝚎 𝚠𝚊𝚒𝚝...", event.threadID);
  ...
  try {
    ...
    if (response.data.output) {
      ...
      api.sendMessage('🚫 𝙶𝚘𝚖𝚎𝚗 𝚜𝚎𝚗𝚜𝚎𝚒, 𝚋𝚞𝚝 𝚊𝚗 𝚎𝚛𝚛𝚘𝚛 𝚘𝚌𝚌𝚞𝚛𝚎𝚍 𝚍𝚞𝚛𝚒𝚗𝚐 𝚝𝚑𝚎 𝚐𝚝𝚊 𝚙𝚛𝚘𝚌𝚎𝚜𝚜.', event.threadID);
    }
  } catch (error) {
