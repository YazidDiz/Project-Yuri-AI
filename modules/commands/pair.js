module.exports.config = {
	...
	hasPermssion: 0,
	credits: "Réynél",
	description: "pair to someone in your group",
...
var one = senderID, two = id;
    return makeImage({ one, two }).then(path => api.sendMessage({ body: `𝖢𝗈𝗇𝗀𝗋𝖺𝗍𝗎𝗅𝖺𝗍𝗂𝗈𝗇𝗌 𝗌𝖾𝗇𝗌𝖾𝗂 ${namee} 𝗁𝖺𝗌 𝖻𝖾𝖾𝗇 𝗉𝖺𝗂𝗋𝖾𝖽 𝗐𝗂𝗍𝗁 ${name}\n𝖳𝗁𝖾 𝗆𝖺𝗍𝖼𝗁 𝗋𝖺𝗍𝖾 𝗂𝗌: ${tle}`, mentions: arraytag, attachment: fs.createReadStream(path) }, threadID, () => fs.unlinkSync(path), messageID));
                                          }