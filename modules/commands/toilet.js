...
try {
  ...
  const canvas = Canvas.createCanvas(500, 670);
	...
	fs.writeFileSync(path_toilet,imageBuffer);
	 api.sendMessage({attachment: fs.createReadStream(path_toilet, {'highWaterMark': 128 * 1024}), body: "𝖥𝗅𝗎𝗌𝗁𝗂𝗇𝗀 𝗍𝗁𝗂𝗌 𝗌𝗁𝗂́𝗍 𝖺𝗐𝖺𝗒!!"}, event.threadID, () => fs.unlinkSync(path_toilet), event.messageID);
}
