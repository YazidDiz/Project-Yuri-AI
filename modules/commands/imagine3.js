...
module.exports.run = async function ({ api, event, args }) {
  try {
      ...
      if (!query) {
        return api.sendMessage("ℹ️ | 𝖲𝖾𝗇𝗌𝖾𝗂, 𝗉𝗅𝖾𝖺𝗌𝖾 𝗉𝗋𝗈𝗏𝗂𝖽𝖾 𝖺 𝗉𝗋𝗈𝗆𝗉𝗍 𝗍𝗈 𝗀𝖾𝗇𝖾𝗋𝖺𝗍𝖾 𝗂𝗆𝖺𝗀𝖾.", event.threadID, event.messageID);
      }
      ...
      const waitingMessage = await api.sendMessage("⏳ | 𝖯𝗋𝗈𝖼𝖾𝗌𝗌𝗂𝗇𝗀, 𝗉𝗅𝖾𝖺𝗌𝖾 𝗐𝖺𝗂𝗍...", event.threadID, event.mesaageID);
