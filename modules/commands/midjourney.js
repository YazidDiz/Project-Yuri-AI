...
module.exports.handleEvent = async function ({ api, event }) {
  ...
  api.sendMessage("🕟 | 𝚂𝚎𝚗𝚜𝚎𝚒, 𝙼𝚒𝚍𝚓𝚘𝚞𝚛𝚗𝚎𝚢 𝙶𝚎𝚗𝚎𝚛𝚊𝚝𝚒𝚗𝚐 𝙿𝚛𝚘𝚖𝚙𝚝, 𝙿𝚕𝚎𝚊𝚜𝚎 𝚠𝚊𝚒𝚝...", event.threadID);
  ...
  try {
    ...
    if (response.data.output) {
      ...
      if (imageData && Array.isArray(imageData)) {
        ...
        api.sendMessage("🚫 | 𝙶𝚘𝚖𝚎𝚗 𝚜𝚎𝚗𝚜𝚎𝚒, 𝚋𝚞𝚝 𝚗𝚘 𝚒𝚖𝚊𝚐𝚎 𝚏𝚘𝚞𝚗𝚍 𝚒𝚗 𝚝𝚑𝚎 𝚛𝚎𝚜𝚙𝚘𝚗𝚜𝚎.", event.threadID);
      }
    } else {
      api.sendMessage("🚫 | 𝙶𝚘𝚖𝚎𝚗 𝚜𝚎𝚗𝚜𝚎𝚒, 𝚋𝚞𝚝 𝚗𝚘 𝚍𝚊𝚝𝚊 𝚏𝚘𝚞𝚗𝚍 𝚒𝚗 𝚝𝚑𝚎 𝚛𝚎𝚜𝚙𝚘𝚗𝚜𝚎.", event.threadID);
    }
  } catch (error) {
    console.error("🚫 | 𝙴𝚛𝚛𝚘𝚛:", error.message);
    api.sendMessage("🚫 | 𝙶𝚘𝚖𝚎𝚗 𝚜𝚎𝚗𝚜𝚎𝚒, 𝚊𝚗 𝚎𝚛𝚛𝚘𝚛 𝚘𝚌𝚌𝚞𝚛𝚎𝚍 𝚠𝚑𝚒𝚕𝚎 𝚙𝚛𝚘𝚌𝚎𝚜𝚜𝚒𝚗𝚐 𝚝𝚑𝚎 𝚛𝚎𝚚𝚞𝚎𝚜𝚝.", event.threadID);
  }
};
