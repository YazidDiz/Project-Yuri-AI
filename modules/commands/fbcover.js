...
if ((this.config.credits) != "Réynél") { return api.sendMessage(`[ 𝗪𝗔𝗥𝗡𝗜𝗡𝗚 ] - 𝖣𝖾𝗍𝖾𝖼𝗍𝗂𝗇𝗀 𝖼𝗋𝖾𝖽𝗂𝗍𝗌 𝗆𝗈𝖽𝗎𝗅𝖾𝗌 ${this.config.name} 𝗐𝖺𝗌 𝖼𝗁𝖺𝗇𝗀𝖾𝖽 𝗍𝗈 ${this.config.credits} 𝖻𝗒 𝖠𝖣𝖬𝖨𝖭𝖡𝖮𝖳 ${global.config.BOTNAME} 😐 𝗦𝘁𝗼𝗽 𝗶𝗺𝗺𝗲𝗱𝗶𝗮𝘁𝗲𝗹𝘆!!!`, event.threadID, event.messageID)}
    const request = require('request');
  const fs = require("fs-extra")
  const axios = require("axios")
  const { threadID, messageID, senderID, body } = event;
  if(!args[0]) return api.sendMessage('ℹ️ | 𝖲𝖾𝗇𝗌𝖾𝗂, 𝗉𝗅𝖾𝖺𝗌𝖾 𝖾𝗇𝗍𝖾𝗋 𝗍𝗁𝖾 𝗆𝖺𝗂𝗇 𝗇𝖺𝗆𝖾 (𝖿𝖺𝗄𝖾 𝗇𝖺𝗆𝖾 𝗈𝗋 𝗋𝖾𝖺𝗅)', threadID, messageID)
  else return api.sendMessage(`🔍 | 𝖲𝖾𝗇𝗌𝖾𝗂, 𝗒𝗈𝗎 𝖼𝗁𝗈𝗌𝖾 𝗍𝗁𝖾 𝗆𝖺𝗂𝗇 𝗇𝖺𝗆𝖾: ${args.join(" ").toUpperCase()}\n\nℹ️ | 𝖲𝖾𝗇𝗌𝖾𝗂, 𝗄𝗂𝗇𝖽𝗅𝗒 𝗋𝖾𝗉𝗅𝗒 𝗍𝗈 𝗍𝗁𝗂𝗌 𝗆𝖾𝗌𝗌𝖺𝗀𝖾 𝖺𝗇𝖽 𝖼𝗁𝗈𝗈𝗌𝖾 𝗒𝗈𝗎𝗋 𝗌𝖾𝖼𝗈𝗇𝖽𝖺𝗋𝗒 𝗇𝖺𝗆𝖾 (𝖿𝖺𝗄𝖾 𝗌𝖾𝖼𝗈𝗇𝖽𝖺𝗋𝗒 𝗇𝖺𝗆𝖾 𝗈𝗋 𝗇𝗈𝗍)`,event.threadID, (err, info) => {
  ...
  switch (handleReply.type) {
    ...
    case "create": {
      ...
      return api.sendMessage(
        { body: "✅ | 𝖲𝖾𝗇𝗌𝖾𝗂, 𝗁𝖾𝗋𝖾'𝗌 𝗒𝗈𝗎𝗋 𝖿𝖻𝖼𝗈𝗏𝖾𝗋:", attachment: fs.createReadStream(pathImg) },
        threadID,messageID
      );
    }
  }
