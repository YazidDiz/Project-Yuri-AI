module.exports.config = {
	...
	hasPermssion: 0,
	credits: "Réynél",
	description: "mention someone who's wanted",
...
module.exports.run = async ({ event, api, args, Users }) => {
  ...
  api.sendMessage({body: "𝗕𝗿𝗲𝗮𝗸𝗶𝗻𝗴 𝗻𝗲𝘄𝘀!!", attachment: fs.createReadStream(path_wanted)}, event.threadID, () => fs.unlinkSync(path_wanted), event.messageID);
}