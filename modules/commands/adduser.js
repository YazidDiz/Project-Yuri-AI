...
module.exports.run = async function ({ api, event, args }) {
	...
	if (!args[0]) return out("ℹ️ | 𝖲𝖾𝗇𝗌𝖾𝗂, 𝗉𝗅𝖾𝖺𝗌𝖾 𝖾𝗇𝗍𝖾𝗋 𝟣 𝖨𝖣/𝖫𝗂𝗇𝗄 𝗉𝗋𝗈𝖿𝗂𝗅𝖾 𝗎𝗌𝖾𝗋 𝗇𝖾𝖾𝖽 𝗍𝗈 𝖺𝖽𝖽 𝗂𝗇 𝗍𝗁𝗂𝗌 𝗀𝗋𝗈𝗎𝗉");
	if (!isNaN(args[0])) return adduser(args[0], undefined);
	else {
		try {
			var [id, name, fail] = await getUID(args[0], api);
			if (fail == true && id != null) return out(id);
			else if (fail == true && id == null) return out("❎ | 𝖲𝖾𝗇𝗌𝖾𝗂, 𝗍𝗁𝖾 𝗎𝗌𝖾𝗋 𝖨𝖣 𝗂𝗌 𝗇𝗈𝗍 𝖿𝗈𝗎𝗇𝖽.")
			else {
	...
	async function adduser(id, name) {
		id = parseInt(id);
		if (participantIDs.includes(id)) return out(`ℹ️ | 𝖲𝖾𝗇𝗌𝖾𝗂 ${name ? name : "Member"} 𝖺𝗋𝖾 𝖺𝗅𝗋𝖾𝖺𝖽𝗒 𝗂𝗇 𝗍𝗁𝗂𝗌 𝗀𝗋𝗈𝗎𝗉.`);
		else {
			...
			try {
				...
				return out(`❎ | 𝖦𝗈𝗆𝖾𝗇 𝗌𝖾𝗇𝗌𝖾𝗂, 𝖻𝗎𝗍 𝖨 𝖼𝖺𝗇'𝗍 𝖺𝖽𝖽 ${name ? name : "user"} 𝗂𝗇 𝗍𝗁𝗂𝗌 𝗀𝗋𝗈𝗎𝗉`);
			}
			if (approvalMode === true && !admins.includes(botID)) return out(`✅ | 𝖲𝖾𝗇𝗌𝖾𝗂, 𝗌𝗎𝖼𝖼𝖾𝗌𝗌𝖿𝗎𝗅𝗅𝗒 𝖺𝖽𝖽𝖾𝖽 ${name ? name : "member"} 𝗍𝗈 𝗍𝗁𝖾 𝖺𝗉𝗉𝗋𝗈𝗏𝖾𝖽 𝗅𝗂𝗌𝗍`);
			else return out(`✅ | 𝖲𝖾𝗇𝗌𝖾𝗂, 𝖺𝖽𝖽𝖾𝖽 ${name ? name : "member"} 𝗌𝗎𝖼𝖼𝖾𝗌𝗌𝖿𝗎𝗅𝗅𝗒 𝗂𝗇 𝗍𝗁𝗂𝗌 𝗀𝗋𝗈𝗎𝗉`)
		}
	}
    }