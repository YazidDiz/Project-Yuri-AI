...
module.exports.run = async function ({ api, event, args, Users }) {
  ...
  let text = args.join(" ")
  if (!text) return api.sendMessage('ℹ️ | 𝖲𝖾𝗇𝗌𝖾𝗂, 𝗄𝗂𝗇𝖽𝗅𝗒 𝖾𝗇𝗍𝖾𝗋 𝗍𝗁𝖾 𝖼𝗈𝗋𝗋𝖾𝖼𝗍 𝖿𝗈𝗋𝗆𝖺𝗍 [𝖳𝖾𝗑𝗍𝟣 - 𝖳𝖾𝗑𝗍𝟤]', event.threadID, event.messageID);
  const text1 = text.substr(0, text.indexOf(' - ')); 
  if (!text1) return api.sendMessage('ℹ️ | 𝖲𝖾𝗇𝗌𝖾𝗂, 𝗄𝗂𝗇𝖽𝗅𝗒 𝖾𝗇𝗍𝖾𝗋 𝗍𝗁𝖾 𝖼𝗈𝗋𝗋𝖾𝖼𝗍 𝖿𝗈𝗋𝗆𝖺𝗍 [𝖳𝖾𝗑𝗍𝟣 - 𝖳𝖾𝗑𝗍𝟤]', event.threadID, event.messageID);
  const text2 = text.split(" - ").pop()
  if (!text2) return api.sendMessage('ℹ️ | 𝖲𝖾𝗇𝗌𝖾𝗂, 𝗄𝗂𝗇𝖽𝗅𝗒 𝖾𝗇𝗍𝖾𝗋 𝗍𝗁𝖾 𝖼𝗈𝗋𝗋𝖾𝖼𝗍 𝖿𝗈𝗋𝗆𝖺𝗍 [𝖳𝖾𝗑𝗍𝟣 - 𝖳𝖾𝗑𝗍𝟤]', event.threadID, event.messageID);
  let Avatar = (
    await axios.get(
  ...
  return api.sendMessage(
    { body: "✅ | 𝖲𝖾𝗇𝗌𝖾𝗂, 𝗁𝖾𝗋𝖾'𝗌 𝗒𝗈𝗎𝗋 𝖼𝗈𝗏𝖾𝗋 𝗉𝗁𝗈𝗍𝗈:", attachment: fs.createReadStream(pathImg) },
    threadID,
