...
async function handleNyxImageCommand(api, event) {
  ...
  if (!txt || !txt2) {
    return api.sendMessage("🎀 | 𝙺𝚘𝚗𝚗𝚒𝚌𝚑𝚒𝚠𝚊 𝚖𝚒𝚗𝚊-𝚜𝚊𝚗 𝚝𝚘 𝚞𝚜𝚎 𝙽𝚢𝚡 𝙰𝙸 𝚠𝚒𝚝𝚑 𝚙𝚛𝚘𝚖𝚙𝚝.\n❆━━━━━━━━━━━━━━━━━❆\n𝚄𝚜𝚎: 𝚗𝚢𝚡𝚖𝚊𝚐𝚎 [ 𝚙𝚛𝚘𝚖𝚙𝚝 ] - [ 𝚖𝚘𝚍𝚎𝚕 ] 𝚋𝚎𝚝𝚠𝚎𝚎𝚗 1-20.", event.threadID, event.messageID);
  }

  api.sendMessage("🗨️ | 𝚂𝚎𝚗𝚜𝚎𝚒, 𝙽𝚢𝚡 𝙰𝙸 𝙶𝚎𝚗𝚎𝚛𝚊𝚝𝚒𝚗𝚐 𝚙𝚛𝚘𝚖𝚙𝚝, 𝙿𝚕𝚎𝚊𝚜𝚎 𝚠𝚊𝚒𝚝...", event.threadID, event.messageID);
  ...
  try {
    ...
    api.sendMessage("🚫 | 𝙶𝚘𝚖𝚎𝚗 𝚜𝚎𝚗𝚜𝚎𝚒, 𝚋𝚞𝚝 𝚎𝚛𝚛𝚘𝚛 𝚒𝚗 𝙸𝚖𝚊𝚐𝚎 𝙶𝚎𝚗𝚎𝚛𝚊𝚝𝚒𝚘𝚗", event.threadID, event.messageID);
  }
}

async function convertVoiceToText(audioUrl, api, event) {
  try {
    api.sendMessage("💽 | 𝚂𝚎𝚗𝚜𝚎𝚒, 𝙽𝚢𝚡 𝙰𝙸 𝙲𝚘𝚗𝚟𝚎𝚛𝚝𝚒𝚗𝚐 𝙰𝚞𝚍𝚒𝚘, 𝙿𝚕𝚎𝚊𝚜𝚎 𝚠𝚊𝚒𝚝...", event.threadID);
    ...
    if (text && isFontEnabled) {
      ...
      api.sendMessage("🚫 | 𝙶𝚘𝚖𝚎𝚗 𝚜𝚎𝚗𝚜𝚎𝚒, 𝚋𝚞𝚝 𝚞𝚗𝚊𝚋𝚕𝚎 𝚝𝚘 𝚌𝚘𝚗𝚟𝚎𝚛𝚝 𝚊𝚞𝚍𝚒𝚘.", event.threadID, event.messageID);
    }
  } catch (error) {
    console.error("🚫 | 𝙶𝚘𝚖𝚎𝚗 𝚜𝚎𝚗𝚜𝚎𝚒, 𝚋𝚞𝚝 𝚊𝚗 𝚎𝚛𝚛𝚘𝚛 𝚘𝚌𝚌𝚞𝚛𝚎𝚍 𝚠𝚑𝚒𝚕𝚎 𝚌𝚘𝚗𝚟𝚎𝚛𝚝𝚒𝚗𝚐 𝚊𝚞𝚍𝚒𝚘:", error);
    api.sendMessage("🚫 | 𝙶𝚘𝚖𝚎𝚗 𝚜𝚎𝚗𝚜𝚎𝚒, 𝚋𝚞𝚝 𝚊𝚗 𝚎𝚛𝚛𝚘𝚛 𝚘𝚌𝚌𝚞𝚛𝚎𝚍 𝚠𝚑𝚒𝚕𝚎 𝚌𝚘𝚗𝚟𝚎𝚛𝚝𝚒𝚗𝚐 𝚊𝚞𝚍𝚒𝚘.", event.threadID, event.messageID);
  }
}
...
module.exports.handleEvent = async function ({ api, event, Users }) {
  ...
  try {
    api.sendMessage("🗨️ | 𝚂𝚎𝚗𝚜𝚎𝚒, 𝙽𝚢𝚡 𝙰𝙸 𝚒𝚜 𝚝𝚑𝚒𝚗𝚔𝚒𝚗𝚐...", event.threadID, event.messageID);
