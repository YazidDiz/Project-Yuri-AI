...
module.exports.run = async function({ api, event, args }) {
  if (!args[0]) {
    api.sendMessage("ℹ️ | 𝖲𝖾𝗇𝗌𝖾𝗂, 𝗉𝗅𝖾𝖺𝗌𝖾 𝗉𝗋𝗈𝗏𝗂𝖽𝖾 𝖺 𝖼𝗈𝗎𝗇𝗍𝗋𝗒 𝗇𝖺𝗆𝖾.", event.threadID, event.messageID);
    return;
  }
  ...
  try {
    ...
    if (!countryData.length) {
      api.sendMessage(`❎ | 𝖦𝗈𝗆𝖾𝗇𝗇𝖺𝗌𝖺𝗂 𝖲𝖾𝗇𝗌𝖾𝗂, 𝖻𝗎𝗍 𝗇𝗈 𝗂𝗇𝖿𝗈𝗋𝗆𝖺𝗍𝗂𝗈𝗇 𝖿𝗈𝗎𝗇𝖽 𝖿𝗈𝗋 𝗍𝗁𝖾 𝖼𝗈𝗎𝗇𝗍𝗋𝗒 "${args.join(" ")}".`, event.threadID, event.messageID);
      return;
    }
...
𝗖𝗢𝗨𝗡𝗧𝗥𝗬: ${name} (${officialName})\n𝗖𝗔𝗣𝗜𝗧𝗔𝗟: ${capital || "N/A"}\n𝗥𝗘𝗚𝗜𝗢𝗡: ${region}\n𝗣𝗢𝗣𝗨𝗟𝗔𝗧𝗜𝗢𝗡: ${population}\n𝗟𝗔𝗡𝗚𝗨𝗔𝗚𝗘𝗦: ${languages}\n𝗧𝗜𝗠𝗘𝗭𝗢𝗡𝗘𝗦: ${timezones}\n𝗖𝗢𝗡𝗧𝗜𝗡𝗘𝗡𝗧𝗦: ${continents}\n𝗚𝗢𝗢𝗚𝗟𝗘 𝗠𝗔𝗣𝗦: ${googleMaps}\n𝗢𝗣𝗘𝗡𝗦𝗧𝗥𝗘𝗘𝗧 𝗠𝗔𝗣𝗦: ${openStreetMaps}\n\n𝗙𝗟𝗔𝗚𝗦:\n[𝗣𝗡𝗚](${flagsPNG})\n[𝗦𝗩𝗚](${flagsSVG})
    ...
    api.sendMessage("❎ | 𝖦𝗈𝗆𝖾𝗇𝗇𝖺𝗌𝖺𝗂 𝖲𝖾𝗇𝗌𝖾𝗂, 𝖻𝗎𝗍 𝖺𝗇 𝖾𝗋𝗋𝗈𝗋 𝗈𝖼𝖼𝗎𝗋𝗋𝖾𝖽 𝗐𝗁𝗂𝗅𝖾 𝖿𝖾𝗍𝖼𝗁𝗂𝗇𝗀 𝖼𝗈𝗎𝗇𝗍𝗋𝗒 𝗂𝗇𝖿𝗈𝗋𝗆𝖺𝗍𝗂𝗈𝗇. 𝖯𝗅𝖾𝖺𝗌𝖾 𝗍𝗋𝗒 𝖺𝗀𝖺𝗂𝗇 𝗅𝖺𝗍𝖾𝗋.", event.threadID, event.messageID);
