...
module.exports.run = async function({ api, event }) {
	...
	if (event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
		api.changeNickname(`《 ${global.config.PREFIX} 》 ❖ 𝙿𝚛𝚘𝚓𝚎𝚌𝚝 ${(!global.config.BOTNAME) ? " " : global.config.BOTNAME}`, threadID, api.getCurrentUserID());
		return api.sendMessage(`🌟 | 𝖪𝗈𝗇𝗇𝗂𝖼𝗁𝗂𝗐𝖺 𝗆𝗂𝗇𝖺-𝗌𝖺𝗇 𝖨'𝗆 𝗣𝗿𝗼𝗷𝗲𝗰𝘁 ${global.config.BOTNAME}, 𝖼𝗈𝗇𝗇𝖾𝖼𝗍𝖾𝖽 𝗂𝗇 𝗍𝗁𝗂𝗌 𝗀𝗋𝗈𝗎𝗉 𝗌𝗎𝖼𝖼𝖾𝗌𝗌𝖿𝗎𝗅𝗅𝗒!
✿━━━━━━━━━━━━━━━━━✿
🎓 | 𝗨𝘀𝗲:
${global.config.PREFIX}𝗁𝖾𝗅𝗉 𝗍𝗈 𝗏𝗂𝖾𝗐 𝗍𝗁𝖾 𝗅𝗂𝗌𝗍𝗌 𝗈𝖿 𝗆𝗒 𝖼𝗈𝗆𝗆𝖺𝗇𝖽𝗌 𝗈𝗋
${global.config.PREFIX}𝗁𝖾𝗅𝗉 [𝖼𝗈𝗆𝗆𝖺𝗇𝖽 𝗇𝖺𝗆𝖾] 𝗍𝗈 𝗏𝗂𝖾𝗐 𝗈𝗇 𝗁𝗈𝗐 𝗍𝗈 𝗎𝗌𝖾 𝗍𝗁𝖾 𝖼𝗈𝗆𝗆𝖺𝗇𝖽
✿━━━━━━━━━━━━━━━━━✿
🌟 | 𝖧𝖺𝗏𝖾 𝖿𝗎𝗇 𝗎𝗌𝗂𝗇𝗀 𝗆𝖾 𝗆𝗂𝗇𝖺-𝗌𝖺𝗇, 𝗃𝗎𝗌𝗍 𝗄𝗂𝗇𝖽𝗅𝗒 𝗉𝗅𝖾𝖺𝗌𝖾 𝖽𝗈𝗇'𝗍 𝗌𝗉𝖺𝗆 𝗆𝖾 💛`, threadID);
	}
	else {
		try {
    const request = require("request");
...
memLength.sort((a, b) => a - b);
			...
			(typeof threadData.customJoin == "undefined") ? msg = "🌟 | 𝖨𝗋𝗋𝖺𝗌𝗁𝖺𝗂𝗆𝖺𝗌𝖾 𝖲𝖾𝗇𝗌𝖾𝗂  {uName}\n╭┉┉┅┉┅┄┄•◦ೋ•◦❥•◦ೋ\n----- 𝘞𝘦𝘭𝘤𝘰𝘮𝘦 𝘵𝘰 {threadName} -----\n•◦ೋ•◦❥•◦ೋ•┈┄┄┅┉┅┉╯\n {soThanhVien}𝗍𝗁 𝗆𝖾𝗆𝖻𝖾𝗋 𝗈𝖿 𝗍𝗁𝗂𝗌 𝗀𝗋𝗈𝗎𝗉, 𝗉𝗅𝖾𝖺𝗌𝖾 𝖾𝗇𝗃𝗈𝗒 𝗁𝖾𝗋𝖾 𝖺𝗇𝖽 𝖽𝗈𝗇'𝗍 𝗅𝖾𝖺𝗏𝖾 𝗎𝗌 𝖻𝖾𝗁𝗂𝗇𝖽! 🥳♥" : msg = threadData.customJoin;
			msg = msg
