...
(async function () {
  api.markAsReadAll((err) => {
    ...
    try {
      logger(global.getText('listen', 'startLoadEnvironment'), '《 YURI DATABASE 》');
        ...
        logger.loader(global.getText('listen', 'loadedEnvironmentUser')), logger(global.getText('listen','successLoadEnvironment'),'《 YURI DATABASE 》');
    } catch (error) {
        return logger.loader(global.getText('listen', 'failLoadEnvironment', error), 'error');
    }
}());
	logger(`${api.getCurrentUserID()} - 《 ${global.config.PREFIX} 》 • ${(!global.config.BOTNAME) ? "This bot was made by Clark Shirosuzuka" : global.config.BOTNAME}`, "《 YURI INFO 》");
...
//THIZ BOT WAS MADE BY ME CLARK SHIROSUZUKADO NOT STEAL MY CODE.
